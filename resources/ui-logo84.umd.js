(function(){"use strict";try{if(typeof document<"u"){var a=document.createElement("style");a.appendChild(document.createTextNode(".l84-root[data-v-0fca8b02]{display:flex;flex-direction:column;gap:12px;width:100%;font-family:sans-serif;font-size:13px;color:#ccc}.l84-top[data-v-0fca8b02]{display:flex;gap:12px;flex-wrap:wrap}.l84-panel-svg[data-v-0fca8b02]{flex:2;min-width:280px;display:flex;flex-direction:column;gap:8px}.l84-panel-estados[data-v-0fca8b02]{flex:1;min-width:240px}.l84-controls[data-v-0fca8b02]{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.l84-controls label[data-v-0fca8b02]{font-size:12px;color:#aaa}.l84-controls input[type=number][data-v-0fca8b02]{width:56px;background:#2c2c2a;border:1px solid #555;border-radius:4px;color:#fff;padding:4px 6px;font-size:13px}.l84-controls button[data-v-0fca8b02]{background:#444;border:1px solid #666;border-radius:4px;color:#fff;padding:5px 12px;cursor:pointer;font-size:12px}.l84-controls button[data-v-0fca8b02]:disabled{opacity:.4;cursor:default}.l84-controls button[data-v-0fca8b02]:hover:not(:disabled){background:#555}.l84-slot-label[data-v-0fca8b02]{font-size:12px;color:#5dcaa5;font-family:monospace}.l84-svg-wrap[data-v-0fca8b02]{width:100%;overflow-x:auto}.l84-section-title[data-v-0fca8b02]{font-size:13px;font-weight:600;color:#ddd;margin-bottom:8px;display:flex;align-items:center;gap:8px}.l84-table-estados[data-v-0fca8b02]{width:100%;border-collapse:collapse}.l84-table-estados th[data-v-0fca8b02],.l84-table-estados td[data-v-0fca8b02]{text-align:left;padding:9px 12px;border-bottom:1px solid #2a2a2a}.l84-table-estados th[data-v-0fca8b02]{color:#888;font-weight:500}.l84-table-estados tbody tr[data-v-0fca8b02]{cursor:pointer;transition:background .15s}.l84-table-estados tbody tr[data-v-0fca8b02]:hover{background:#ffffff0a}.l84-row-active[data-v-0fca8b02]{background:#5dcaa514!important}.l84-td-time[data-v-0fca8b02]{font-size:11px;color:#888;white-space:nowrap}.l84-badge[data-v-0fca8b02]{padding:2px 10px;border-radius:999px;font-size:12px}.l84-badge.online[data-v-0fca8b02]{background:#1d9e7526;color:#1d9e75}.l84-badge.offline[data-v-0fca8b02]{background:#e24b4a26;color:#e24b4a}.l84-panel-io[data-v-0fca8b02]{width:100%}.l84-editing[data-v-0fca8b02]{font-size:12px;font-weight:400;color:#888}.l84-editing strong[data-v-0fca8b02]{color:#5dcaa5}.l84-table-io[data-v-0fca8b02]{width:100%;border-collapse:collapse}.l84-table-io th[data-v-0fca8b02],.l84-table-io td[data-v-0fca8b02]{text-align:left;padding:7px 12px;border-bottom:1px solid #2a2a2a}.l84-table-io th[data-v-0fca8b02]{color:#888;font-weight:500}.l84-pin-id[data-v-0fca8b02]{font-family:monospace;color:#aaa;width:60px}.l84-table-io input[data-v-0fca8b02]{width:100%;background:#2c2c2a;border:1px solid #444;border-radius:4px;color:#fff;padding:5px 8px;font-size:12px;box-sizing:border-box}.l84-table-io input[data-v-0fca8b02]:focus{outline:none;border-color:#5dcaa5}.l84-empty[data-v-0fca8b02]{color:#666;font-size:12px;padding:8px 0}")),document.head.appendChild(a)}}catch(t){console.error("vite-plugin-css-injected-by-js",t)}})();
