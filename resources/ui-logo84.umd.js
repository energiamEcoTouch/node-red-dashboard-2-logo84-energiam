(function(){"use strict";try{if(typeof document<"u"){var a=document.createElement("style");a.appendChild(document.createTextNode(".l84-root[data-v-766219a3]{display:flex;flex-direction:column;gap:12px;width:100%;font-family:sans-serif;font-size:13px;color:#ccc}.l84-top[data-v-766219a3]{display:flex;gap:12px;flex-wrap:wrap}.l84-panel-svg[data-v-766219a3]{flex:2;min-width:280px;display:flex;flex-direction:column;gap:8px}.l84-panel-estados[data-v-766219a3]{flex:1;min-width:240px}.l84-controls[data-v-766219a3]{display:flex;align-items:center;gap:8px;flex-wrap:wrap}.l84-controls label[data-v-766219a3]{font-size:12px;color:#aaa}.l84-controls input[type=number][data-v-766219a3]{width:56px;background:#2c2c2a;border:1px solid #555;border-radius:4px;color:#fff;padding:4px 6px;font-size:13px}.l84-controls button[data-v-766219a3]{background:#444;border:1px solid #666;border-radius:4px;color:#fff;padding:5px 12px;cursor:pointer;font-size:12px}.l84-controls button[data-v-766219a3]:disabled{opacity:.4;cursor:default}.l84-controls button[data-v-766219a3]:hover:not(:disabled){background:#555}.l84-slot-label[data-v-766219a3]{font-size:12px;color:#5dcaa5;font-family:monospace}.l84-svg-wrap[data-v-766219a3]{width:100%;overflow-x:auto}.l84-section-title[data-v-766219a3]{font-size:18px;font-weight:700;color:#fff;margin-bottom:8px;display:flex;align-items:center;gap:8px}.l84-table-estados[data-v-766219a3]{width:100%;border-collapse:collapse}.l84-table-estados th[data-v-766219a3],.l84-table-estados td[data-v-766219a3]{text-align:left;padding:9px 12px;border-bottom:1px solid #2a2a2a}.l84-table-estados th[data-v-766219a3]{color:#888;font-weight:500}.l84-table-estados tbody tr[data-v-766219a3]{cursor:pointer;transition:background .15s}.l84-table-estados tbody tr[data-v-766219a3]:hover{background:#ffffff0a}.l84-row-active[data-v-766219a3]{background:#5dcaa514!important}.l84-td-time[data-v-766219a3]{font-size:11px;color:#888;white-space:nowrap}.l84-badge[data-v-766219a3]{padding:2px 10px;border-radius:999px;font-size:12px}.l84-badge.online[data-v-766219a3]{background:#1d9e7526;color:#1d9e75}.l84-badge.offline[data-v-766219a3]{background:#e24b4a26;color:#e24b4a}.l84-panel-io[data-v-766219a3]{width:100%;background:#1a1a1a;border-radius:6px;padding:14px 16px;box-sizing:border-box}.l84-editing[data-v-766219a3]{font-size:13px;font-weight:400;color:#aaa;display:block;margin-top:2px;margin-bottom:10px}.l84-editing strong[data-v-766219a3]{color:#5dcaa5}.l84-table-io[data-v-766219a3]{width:100%;border-collapse:collapse}.l84-table-io th[data-v-766219a3],.l84-table-io td[data-v-766219a3]{text-align:left;padding:10px 14px;border-bottom:1px solid #2a2a2a}.l84-table-io th[data-v-766219a3]{color:#fff;font-weight:700;font-size:14px}.l84-pin-id[data-v-766219a3]{font-family:monospace;color:#fff;width:60px;font-size:14px;font-weight:500}.l84-table-io input[data-v-766219a3]{width:100%;background:#2c2c2a;border:1px solid #444;border-radius:4px;color:#fff;padding:6px 10px;font-size:13px;box-sizing:border-box}.l84-table-io input[data-v-766219a3]::placeholder{color:#666}.l84-table-io input[data-v-766219a3]:focus{outline:none;border-color:#5dcaa5}.l84-empty[data-v-766219a3]{color:#666;font-size:12px;padding:8px 0}")),document.head.appendChild(a)}}catch(o){console.error("vite-plugin-css-injected-by-js",o)}})();
(function(g,t){typeof exports=="object"&&typeof module<"u"?t(exports,require("vue")):typeof define=="function"&&define.amd?define(["exports","vue"],t):(g=typeof globalThis<"u"?globalThis:g||self,t(g["ui-logo84"]={},g.Vue))})(this,function(g,t){"use strict";const $=(e,o)=>{const d=e.__vccOpts||e;for(const[c,r]of o)d[c]=r;return d},u={name:"UILogo84",inject:["$socket"],props:{id:{type:String,required:!0},props:{type:Object,default:()=>({})},msg:{type:Object,default:()=>({})}},data(){return{tableData:[],selectedLogo:null,editNIn:8,editNOut:4,pins:[],pinNames:{},_logoForPins:null}},mounted(){this.buildPLC(),this.$socket.on("msg-input:"+this.id,e=>{e&&e.payload&&this.handleMsg(e.payload)}),this.$socket.on("widget-load:"+this.id,e=>{e&&e.payload&&this.handleMsg(e.payload)}),this.$socket.emit("widget-action",this.id,{payload:{action:"get_state"}})},beforeUnmount(){this.$socket.off("msg-input:"+this.id),this.$socket.off("widget-load:"+this.id)},methods:{send(e,o){this.$socket.emit("widget-action",this.id,{payload:{action:e,value:o}})},selectLogo(e){this.selectedLogo=e,this.send("select_logo",e)},applyConfig(){if(!this.selectedLogo)return;const e=Math.max(1,Math.min(20,this.editNIn||8)),o=Math.max(1,Math.min(16,this.editNOut||4));this.editNIn=e,this.editNOut=o,this.buildPLC(),this.send("save_config",{logo:this.selectedLogo,nIn:e,nOut:o})},savePinName(e,o){this.selectedLogo&&(this.pinNames={...this.pinNames,[e]:o},this.send("save_pin_names",{logo:this.selectedLogo,names:{...this.pinNames}}))},handleMsg(e){if(e){if(e.type==="restore_state"){Array.isArray(e.tableData)&&(this.tableData=e.tableData),e.selectedLogo&&(this.selectedLogo=e.selectedLogo),this._applyLogoData(e.logoData);return}e.type==="state_update"&&(Array.isArray(e.tableData)&&(this.tableData=e.tableData),e.logoData&&e.logoData.slot===this.selectedLogo&&this._applyLogoData(e.logoData))}},_applyLogoData(e){if(!e)return;const o=e.nIn||8,d=e.nOut||4;e.slot!==this._logoForPins&&(this.editNIn=o,this.editNOut=d,this.buildPLC(),this.buildPins(o,d),this._logoForPins=e.slot,e.pinNames&&(this.pinNames={...e.pinNames})),this.applyState(e)},buildPins(e,o){const d=[];for(let c=1;c<=e;c++)d.push({id:`I${c}`});for(let c=1;c<=o;c++)d.push({id:`Q${c}`});this.pins=d},buildPLC(){const e=Math.max(1,Math.min(20,this.editNIn||8)),o=Math.max(1,Math.min(16,this.editNOut||4));this.editNIn=e,this.editNOut=o;const d=this.$refs.plcWrap;if(!d)return;const c=Math.max(560,(Math.max(e,o)+1)*30+80),r=360,s=40,l=70,i=c-80,n=220,a=i/(e+1),m=i/(o+1);let p="";for(let f=0;f<e;f++){const h=s+a*(f+1);p+=`
